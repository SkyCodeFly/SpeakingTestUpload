      ...
      input: [
        {
          ...
          content: [
            ...
            "评分要符合小学课堂的鼓励性评价：如果学生完整读出句子，发音清楚自然，可以给 95-100 分。",
            "不要故意压分，也不要因为少量轻微口音或自然停顿扣太多分。",
            "但不能因为语音识别文本看起来接近就自动给高分。",
        ...
        },
        {
          ...
          content: [
            ...
            "请按以下标准评分：",
            "1. 阅读完整性 0-50 分：学生是否读出了目标句子的主要字词、顺序和完整意思。完整读出可给 48-50 分；只漏少量不影响意思的字词可给 42-47 分；漏读、跳读、只读开头、读成别的句子、转写为空都要明显扣分。",
            "2. 发音和读音清晰度 0-50 分：中文声母、韵母、声调、停顿和整体清晰度。发音清楚自然可给 48-50 分；有轻微口音但能清楚理解可给 42-47 分；发音含糊或多处读音错误再降低分数。",
            "如果转写文本与目标句子高度相似，且没有明显错误，可以给高分甚至满分；如果只读了很少内容，不要因为目标句子提示而补全评分。",
